        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{asset('AdminLTE/pages/tables/biodata.blade.php')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{asset('AdminLTE/pages/tables/pengajaran.blade.php')}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Pengajaran
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{asset('AdminLTE/pages/tables/penunjang.blade.php')}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Penunjang
                                </p>
